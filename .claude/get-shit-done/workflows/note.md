...
- **Global scope**: `/Users/meteor/github/XNook/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/meteor/github/XNook/.claude/notes/`)
...
2. Glob `/Users/meteor/github/XNook/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/meteor/github/XNook/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/meteor/github/XNook/.claude/notes/` — works in any directory
