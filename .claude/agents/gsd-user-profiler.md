...
<reference>
@/Users/meteor/github/XNook/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/meteor/github/XNook/.claude/get-shit-done/references/user-profiling.md` to load:
