...
```
Agent(
  prompt="Read /Users/meteor/github/XNook/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/meteor/github/XNook/.claude/get-shit-done/templates/SECURITY.md`
