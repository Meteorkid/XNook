...
```bash
INIT=$(node "/Users/meteor/github/XNook/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/meteor/github/XNook/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
