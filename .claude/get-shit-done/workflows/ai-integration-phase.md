...
<required_reading>
@/Users/meteor/github/XNook/.claude/get-shit-done/references/ai-frameworks.md
@/Users/meteor/github/XNook/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/meteor/github/XNook/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/meteor/github/XNook/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/meteor/github/XNook/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/meteor/github/XNook/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/meteor/github/XNook/.claude/agents/gsd-eval-planner.md for instructions.
