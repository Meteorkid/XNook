...
```bash
INIT=$(node "/Users/meteor/github/XNook/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/meteor/github/XNook/.claude/get-shit-done/templates/spec.md.
