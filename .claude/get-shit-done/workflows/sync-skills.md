...
INSTALL_JS_GLOBAL="/Users/meteor/github/XNook/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/meteor/github/XNook/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
